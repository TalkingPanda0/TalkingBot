 ...
 */
export type PubSubLowTrustUserBanEvasionEvaluationType = 'UNKNOWN_EVADER' | 'UNLIKELY_EVADER' | 'LIKELY_EVADER' | 'POSSIBLE_EVADER' | '';
/**
 * User types (if any) that apply to the suspicious user.
 */
export type PubSubLowTrustUserType = 'UNKNOWN_TYPE' | 'MANUALLY_ADDED' | 'DETECTED_BAN_EVADER' | 'BANNED_IN_SHARED_CHANNEL';
/** @private */
