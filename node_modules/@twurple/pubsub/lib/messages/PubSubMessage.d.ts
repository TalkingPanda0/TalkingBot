...
/** @private */
export type PubSubModActionMessageData = PubSubChatModActionMessageData | PubSubChannelTermsActionMessageData | PubSubChannelRoleChangeMessageData | PubSubUnbanRequestMessageData;
/** @private */
export type PubSubMessageData = PubSubAutoModQueueMessageData | PubSubBitsMessageData | PubSubBitsBadgeUnlockMessageData | PubSubLowTrustUserMessageData | PubSubModActionMessageData | PubSubRedemptionMessageData | PubSubSubscriptionMessageData | PubSubUserModerationNotificationMessageData | PubSubWhisperMessageData | unknown;
export type PubSubLowTrustUserMessage = PubSubLowTrustUserTreatmentMessage | PubSubLowTrustUserChatMessage;
/** @private */
export type PubSubModActionMessage = PubSubChatModActionMessage | PubSubChannelTermsActionMessage | PubSubChannelRoleChangeMessage | PubSubUnbanRequestMessage;
/** @private */
export type PubSubMessage = PubSubAutoModQueueMessage | PubSubBitsMessage | PubSubBitsBadgeUnlockMessage | PubSubLowTrustUserMessage | PubSubModActionMessage | PubSubRedemptionMessage | PubSubSubscriptionMessage | PubSubUserModerationNotificationMessage | PubSubWhisperMessage | PubSubCustomMessage;
