...
const superchat = (messageData, emitter, channel) => {
    if (messageData === null || messageData === void 0 ? void 0 : messageData.liveChatPaidMessageRenderer) {
        ...
        const responseData = (0, actionsUtils_1.createCommonUserResponse)(messageData.liveChatPaidMessageRenderer);
        responseData.bodyBackgroundColor = (0, utils_1.convertColorToHex6)(bodyBackgroundColor);
        responseData.authorNameTextColor = (0, utils_1.convertColorToHex6)(authorNameTextColor);
        responseData.headerBackgroundColor = (0, utils_1.convertColorToHex6)(headerBackgroundColor);
        responseData.headerTextColor = (0, utils_1.convertColorToHex6)(headerTextColor);
        responseData.bodyTextColor = (0, utils_1.convertColorToHex6)(bodyTextColor);
        responseData.timestampColor = (0, utils_1.convertColorToHex6)(timestampColor);
        responseData.textInputBackgroundColor = (0, utils_1.convertColorToHex6)(textInputBackgroundColor);
        responseData.headerOverlayImage = headerOverlayImage;
        const { value: amount, currency } = (0, __1.convertSymbolCurrencies)(purchaseAmountText.simpleText);
        responseData.amount = amount;
        responseData.currency = currency;
        responseData.formated = purchaseAmountText.simpleText;
        emitter.emit("superchat", Object.assign({ channel }, responseData));
    }
    else if (messageData === null || messageData === void 0 ? void 0 : messageData.liveChatPaidStickerRenderer) {
        ...
        const responseData = (0, actionsUtils_1.createCommonUserResponse)(messageData.liveChatPaidStickerRenderer);
        responseData.moneyChipBackgroundColor = (0, utils_1.convertColorToHex6)(moneyChipBackgroundColor);
        responseData.moneyChipTextColor = (0, utils_1.convertColorToHex6)(moneyChipTextColor);
        responseData.backgroundColor = (0, utils_1.convertColorToHex6)(backgroundColor);
        responseData.formated = purchaseAmountText.simpleText;
        responseData.sticker = (0, utils_1.parseThumbnailToImageItem)(sticker.thumbnails, sticker.accessibility.accessibilityData.label);
        const { value: amount, currency } = (0, __1.convertSymbolCurrencies)(purchaseAmountText.simpleText);
        responseData.amount = amount;
        responseData.currency = currency;
        responseData.formated = purchaseAmountText.simpleText;
        emitter.emit("superchatSticker", Object.assign({ channel }, responseData));
    }
};
exports.default = superchat;
