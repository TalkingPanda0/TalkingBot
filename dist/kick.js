...
exports.Kick = exports.parseKickEmotes = exports.removeKickEmotes = void 0;
...
exports.removeKickEmotes = removeKickEmotes;
            ...
            try {
                ...
                switch (jsonData.event) {
                    ...
                    case "App\\Events\\ChatMessageEvent":
                        ...
                        for (let i = 0; i < this.bot.commandList.length; i++) {
                            ...
                            command.commandFunction({
                                ...
                                platform: talkingbot_1.Platform.kick,
                    ...
                    case "App\\Events\\MessageDeletedEvent":
                        this.bot.iochat.emit("deleteMessage", "kick-" + jsonDataSub.message.id);
                        break;
